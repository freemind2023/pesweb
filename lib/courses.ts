...
export const courses: Course[] = [
  ...
  },
  {
    ...
    name: 'Practical BBA',
    shortName: 'BBA',
    tagline: 'Build Real Business Skills. Go Global. Lead. Manage. Grow.',
    duration: '3 Years',
    eligibility: '12th Pass',
    mode: 'Classroom + OJT',
    image: '/brand/courses/bba.jpg',
    dubaiPlacement: true,
    description: '3-Year Business Management & International Business with Dubai Placement',
    color: '#0A1F5C',
    badge: '3 Years',
    subjects: [
      ...
      'Supply Chain & Operations Management', 'International Business & Import-Export Essentials',
      'Cross Culture Communication & Negotiations', 'International Business Laws',
      'Data Analysis and Decision Making', 'Business Networking',
    ],
    careerOutcomes: ['Business Manager', 'HR Executive', 'Marketing Manager', 'Operations Lead', 'Sales Executive', 'Import-Export Manager', 'International Sales Executive', 'Global Trade Analyst'],
    highlights: [
      'International Business & Import-Export exposure',
