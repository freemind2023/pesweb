        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-1 shadow-lg flex-shrink-0">
              <Image src="/tj-college/tj-logo.png" alt="TJ College" width={40} height={40} className="h-9 w-auto rounded-lg object-contain" />
            </div>
            <div className="hidden sm:block leading-tight">
              <p className="text-white text-xs font-bold">Tikaram Jagannath College, Kirkee</p>
              <p className="text-[#F5B400] text-[10px] font-medium">Affiliated to SPPU · AEDP Programs</p>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <a href="tel:+917666676358" className="hidden md:flex items-center gap-1.5 text-white/70 text-sm hover:text-[#F5B400] transition-colors">
              <Phone size={13} className="text-[#F5B400]" /> +91 76666 76358
            </a>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-white/70 text-sm sm:text-base leading-relaxed mb-2 max-w-lg">
              ...
              <span className="text-white font-semibold">Tikaram Jagannath College, Kirkee, Pune.</span>
            </p>
