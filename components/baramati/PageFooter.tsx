      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-white rounded-xl p-1.5">
                <Image src="/brand/peslogo.png" alt="PES" width={44} height={44} className="h-10 w-auto rounded-lg object-contain" />
              </div>
              <div>
                <p className="text-white font-black text-sm leading-tight">College of Practical Commerce</p>
                <p className="text-[#F5B400] text-[10px] font-medium">& Management · Baramati · PES Flagship</p>
              </div>
            </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
            <h3 className="text-[#F5B400] font-bold text-xs uppercase tracking-widest mb-4">Baramati Centre</h3>
            <ul className="space-y-3">
              <li>
                <a href="tel:+919689348709" className="flex items-start gap-2.5 text-white/60 hover:text-white transition-colors text-xs">
                  <Phone size={13} className="text-[#F5B400] mt-0.5 flex-shrink-0" /> +91 96893 48709
                </a>
              </li>
              <li>
              ...
              <li>
                <div className="flex items-start gap-2.5 text-white/60 text-xs">
                  ...
                  <span>Pencil Square Building,<br />Vidyanagari MIDC, Near Mahindra Showroom,<br />Baramati, Maharashtra</span>
                </div>
              </li>
            </ul>
          </motion.div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-white/30 text-[10px]">
            © {new Date().getFullYear()} College of Practical Commerce & Management, Baramati. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
