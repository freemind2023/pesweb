        ...
        {showBar && !barDismissed && (
          <motion.div
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white font-black text-sm truncate">Practical B.COM · Baramati 2025–26!</p>
              <p className="text-white/50 text-[10px] truncate">Limited seats — Apply now</p>
            </div>
