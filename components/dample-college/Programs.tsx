      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <p className="text-gray-500 text-sm mt-2 max-w-xl mx-auto">
            Not a regular B.COM — a job-ready program built around live tools, real projects & 2 years of paid Apprenticeship.
          </p>

          {/* Logo bar */}
          <div className="flex items-center justify-center gap-4 mt-6">
            <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-2xl shadow-md border border-gray-100">
              <Image src="/dample-college/dample-logo.png" alt="Maharashtriya Mandal" width={36} height={36}
                className="h-9 w-auto rounded-lg object-contain" />
              <div className="text-left">
                <p className="text-[#0B1F5C] font-black text-xs leading-tight">Maharashtriya Mandal</p>
                <p className="text-gray-400 text-[10px]">College Of Commerce, Pune</p>
              </div>
            </div>
            <div className="w-px h-8 bg-gray-200" />
            <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-2xl shadow-md border border-gray-100">
              <Image src="/brand/logo.png" alt="PES" width={36} height={36}
                className="h-9 w-auto rounded-lg object-contain" />
              <div className="text-left">
                <p className="text-[#0B1F5C] font-black text-xs leading-tight">Practical EduSkills</p>
                <p className="text-gray-400 text-[10px]">Industry Partner</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative w-full h-64 sm:h-80 overflow-hidden">
            ...
            <div className="absolute top-3 right-3 flex items-center gap-1.5">
              <div className="bg-white/95 rounded-xl p-1 shadow-lg">
                <Image src="/dample-college/dample-logo.png" alt="Maharashtriya Mandal" width={28} height={28}
                  className="h-7 w-7 rounded-lg object-contain" />
              </div>
              <div className="bg-white/95 rounded-xl p-1 shadow-lg">
                <Image src="/brand/logo.png" alt="PES" width={28} height={28}
                  className="h-7 w-7 rounded-lg object-contain" />
              </div>
            </div>
            <div className="absolute bottom-0 left-0 right-0 p-5">
              <span className="inline-block px-2.5 py-1 rounded-full text-[11px] font-black mb-2"
                style={{ background: '#F5B400', color: '#0B1F5C' }}>3 Years · Job Ready</span>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="p-4 rounded-2xl border-2 border-[#10B981]/30" style={{ background: '#ecfdf5' }}>
                ...
                <p className="text-gray-600 text-xs leading-relaxed">
                  On-the-Job Training starts from Second Year — giving you 2 full years of real work experience + ₹8,000–10,000/month stipend.
                </p>
              </div>
        ...
        {/* Bottom college strip */}
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          transition={{ delay: 0.3 }}
          className="mt-10 rounded-3xl overflow-hidden shadow-xl relative h-36 sm:h-44">
          <Image src="/dample-college/dample-building.png" alt="Maharashtriya Mandal College Campus" fill
            className="object-cover object-center" />
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4"
            style={{ background: 'rgba(11,31,92,0.75)' }}>
            ...
            <p className="text-white font-black text-base sm:text-lg">Maharashtriya Mandal College Of Commerce, Pune</p>
            <p className="text-[#F5B400] text-xs font-medium mt-0.5">Practical B.COM · Fintech & Digital Accounting · Powered by PES</p>
          </div>
        </motion.div>
      </div>
    </section>
