...
function buildWAMessage(f: FormData) {
  return encodeURIComponent(
    `Hi, I want to apply for Practical B.COM (Fintech & Digital Accounting) at Maharashtriya Mandal College!\n\nName: ${f.name}\nPhone: ${f.phone}\nEmail: ${f.email}\nCity: ${f.city}\nStream: ${f.stream}\n12th %: ${f.percentage}%\n\nPlease guide me on the admission process.`
  );
}
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <motion.form onSubmit={handleSubmit}
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-6">
            ...
            <a href={`${WA_BASE}Hi%2C+I+want+to+know+about+Practical+BCom+at+Maharashtriya+Mandal+College`}
