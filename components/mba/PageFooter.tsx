        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-white/60 text-xs leading-relaxed mb-4">
              Tech-Powered Corporate Management — Practical MBA with 18 months of On-the-Job Training, leadership mentorship, and executive career pathways.
            </p>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
            <h3 className="text-[#F5B400] font-bold text-xs uppercase tracking-widest mb-4">Practical MBA</h3>
            <ul className="space-y-2">
              {[
                'Tech-Powered Corporate Management',
                '18 Months OJT With Stipend',
