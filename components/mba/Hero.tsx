...
import { MessageCircle, ArrowRight, Phone, ChevronDown, Sparkles, Briefcase, IndianRupee, Award, Users, Download } from 'lucide-react';

const PHRASES = ['EXECUTIVE.', 'LEADERSHIP.', 'CORPORATE EXPERIENCE.'];
const WA = 'https://wa.me/919890959990?text=Hi%2C+I+want+to+know+about+the+Practical+MBA+program+at+Practical+EduSkills';
const WA_BROCHURE = 'https://wa.me/919890959990?text=Hi%2C+please+send+me+the+Practical+MBA+brochure';
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="bg-white rounded-xl p-1 shadow-lg flex-shrink-0">
              <Image src="/brand/peslogo.png" alt="Practical EduSkills" width={40} height={40} className="h-9 w-auto rounded-lg object-contain" />
            </div>
            <div className="w-px h-8 bg-white/20 hidden sm:block" />
            <div className="hidden sm:block leading-tight">
              <p className="text-white text-xs font-bold">Practical EduSkills</p>
              <p className="text-[#F5B400] text-[10px] font-medium devanagari">योगः कर्मसु कौशलम्</p>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <a href="tel:+919890959990" className="hidden md:flex items-center gap-1.5 text-white/70 text-sm hover:text-[#F5B400] transition-colors">
              <Phone size={13} className="text-[#F5B400]" /> 98909 59990
            </a>
      ...
      <div className="relative z-10 flex-1 flex items-center px-4 sm:px-6 py-10">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            >
              <Sparkles size={12} className="animate-pulse" /> APPLICATIONS OPEN
            </motion.span>
            ...
            <h1 className="font-black text-white mb-2 leading-none" style={{ fontSize: 'clamp(1.7rem,5vw,3.3rem)', fontFamily: "'DM Sans',sans-serif" }}>
            ...
            <p className="text-white/70 text-sm sm:text-base leading-relaxed mb-2 max-w-lg">
              ...
              built on <span className="text-white font-semibold">18 months of On-the-Job Training with stipend support</span>{' '}
              and <span className="text-white font-semibold">leadership mentorship from day one.</span>
            </p>
            <p className="text-white/50 text-xs mb-6 border-l-2 border-[#F5B400] pl-3">
              Together, let&apos;s build careers, not just degrees.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              ...
              <a href={WA_BROCHURE} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white text-base border-2 border-white/25 hover:border-[#F5B400] hover:text-[#F5B400] transition-all">
                <Download size={18} /> Download Brochure
              </a>
            </div>

            <div className="flex flex-wrap gap-x-5 gap-y-1">
              {['18 Months OJT With Stipend', 'Executive Career Path', 'Leadership Mentorship', 'Industry Certifications'].map((t) => (
                <span key={t} className="text-xs text-white/55 flex items-center gap-1">
                  <Award size={11} className="text-[#F5B400]" /> {t}
                </span>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}
            ...
            <div className="relative w-full max-w-md">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ border: '2px solid rgba(255,255,255,0.12)' }}>
                <Image src="/brand/courses/mba.jpg" alt="Practical MBA Students" width={480} height={380}
              ...
              {([
                { label: 'Executive Career Path', Icon: Briefcase,  top: '12px',  left: '-20px',  bg: '#F5B400', color: '#0B1F5C', delay: 0.6 },
                { label: '₹12K–18K Stipend', Icon: IndianRupee,    top: '33%',   right: '-20px', bg: '#10B981', color: '#fff',    delay: 0.8 },
                { label: 'Leadership Mentorship', Icon: Users,     bottom: '80px', left: '-20px', bg: '#6366F1', color: '#fff',  delay: 1.0 },
                { label: 'Industry Certifications', Icon: Award,  bottom: '16px', right: '-20px', bg: '#0B1F5C', color: '#F5B400', delay: 1.2 },
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }}
                ...
                <Image src="/brand/hero-poster.jpg" alt="Practical EduSkills Campus" width={480} height={260} className="w-full h-52 sm:h-64 object-cover object-center" />
                <div className="absolute inset-0 flex flex-col items-center justify-end pb-4 px-3" style={{ background: 'linear-gradient(to top, rgba(11,31,92,0.75) 0%, transparent 55%)' }}>
                  <span className="text-white text-xs font-bold drop-shadow-md text-center">Practical EduSkills</span>
                  <span className="text-[#F5B400] text-[10px] font-semibold mt-0.5">Tech-Powered Corporate Management</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
