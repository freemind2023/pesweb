...
const testimonials = [
  { name: 'Priya Sharma', course: 'Practical B.Com', company: 'Deloitte India', quote: 'PES gave me practical skills that college never taught. I got placed in Deloitte during OJT. The Tally and Excel training was a game changer!', rating: 5 },
  { name: 'Rahul Patil', course: 'Applied MBA', company: 'Sales Manager, Pune', quote: 'The evening MBA was perfect for me as a working professional. The 5 specialisation tracks helped me choose exactly what I wanted — Business Development!', rating: 5 },
  { name: 'Sneha Kulkarni', course: 'Practical BBA', company: 'Dubai, UAE', quote: 'I never imagined getting a job in Dubai fresh out of college. PES made it happen with their International Business specialisation. Forever grateful!', rating: 5 },
  { name: 'Amit Desai', course: 'CA Article Placement', company: 'Top CA Firm, Pune', quote: 'Got placed in a top CA firm within 1 month of joining the CA Article program. The Tally and GST training was exactly what firms look for.', rating: 5 },
  { name: 'Kavya Joshi', course: 'B.Sc. AI & Digital Automation', company: 'Digital Marketing Agency', quote: 'Learning AI tools and automation from Day 1 was mind-blowing. I built my own portfolio and got hired before completing the course!', rating: 5 },
  { name: 'Rohan Sawant', course: 'Practical BBA', company: 'HR Executive, MNC', quote: 'The mock interviews and internship drive at PES are incredible. I had 3 job offers before graduating. The faculty mentored us like family.', rating: 5 },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
          ...
          {testimonials.map((t, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
              ...
              <div className="flex items-center gap-1 mb-3">
                {[...Array(t.rating)].map((_, j) => <span key={j} className="text-gold text-sm">★</span>)}
              </div>
        ...
        <div className="md:hidden relative">
          <motion.div key={current} initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -50 }}
            ...
            <div className="flex items-center gap-1 mb-3">
              {[...Array(testimonials[current].rating)].map((_, j) => <span key={j} className="text-gold">★</span>)}
            </div>
