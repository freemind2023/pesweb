...
const testimonials = [
  ...
  { name: 'Sneha Kulkarni', course: 'Practical BBA–IB', company: 'Dubai, UAE', quote: 'I never imagined getting a job in Dubai fresh out of college. PES made it happen with their International Business program. Forever grateful!', rating: 5 },
