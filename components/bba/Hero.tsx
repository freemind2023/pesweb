...
import { MessageCircle, ArrowRight, Phone, ChevronDown, Sparkles, Briefcase, IndianRupee, Globe2, GraduationCap, Check } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block leading-tight">
              <p className="text-white text-xs font-bold">Practical EduSkills · Head Office</p>
              <p className="text-[#F5B400] text-[10px] font-medium devanagari">योगः कर्मसु कौशलम् · Skill India</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-white/50 text-xs font-semibold tracking-wide mb-2 uppercase">
              A Future-Ready Career. A Practical Advantage.
            </p>
            ...
            <p className="text-white/70 text-sm sm:text-base leading-relaxed mb-2 max-w-lg">
              A skill-oriented undergraduate program bridging academic learning and industry expectations —
              with <span className="text-white font-semibold">2 full years of On-the-Job Training</span> at our{' '}
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-1">
              {['SPPU Curriculum', '2 Yrs On-the-Job Training', 'Stipend Support', '12+ Certifications', 'Dubai Placement Track'].map((t) => (
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}
            ...
            <div className="relative w-full max-w-md">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ border: '2px solid rgba(255,255,255,0.12)' }}>
                <Image src="/brand/courses/bba.jpg" alt="Practical BBA Students" width={480} height={380}
              ...
              {([
                { label: 'Job-Ready Skills', Icon: Briefcase,    top: '12px',  left: '-20px',  bg: '#F5B400', color: '#0B1F5C', delay: 0.6 },
                { label: 'Stipend Support', Icon: IndianRupee,    top: '33%',   right: '-20px', bg: '#10B981', color: '#fff',    delay: 0.8 },
                { label: 'International Business', Icon: Globe2, bottom: '80px', left: '-20px', bg: '#6366F1', color: '#fff',  delay: 1.0 },
                { label: 'SPPU Curriculum',   Icon: GraduationCap,  bottom: '16px', right: '-20px', bg: '#0B1F5C', color: '#F5B400', delay: 1.2 },
