...
export default function Programs({ onApply }: { onApply: () => void }) {
  return (
    <section className="py-14 md:py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg,#f0f4ff 0%,#f8f9ff 50%,#eef3ff 100%)' }}>
      ...
      {/* Background trust strip — MC + SPPU building */}
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        <div className="absolute inset-0 opacity-[0.04]">
          <Image src="/modern-college/college-gate.webp" alt="" fill className="object-cover object-center" />
        </div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-2xl shadow-md border border-gray-100">
              <Image src="/modern-college/mc-logo.jpg" alt="Modern College" width={36} height={36} className="h-9 w-auto rounded-lg object-contain" />
              <div className="text-left">
                <p className="text-[#0B1F5C] font-black text-xs leading-tight">Modern College</p>
                <p className="text-gray-400 text-[10px]">Ganeshkhind, Pune</p>
              </div>
            </div>
          </div>
        </motion.div>
            ...
            <motion.div key={p.short}
              ...
              <div className="relative w-full h-56 sm:h-64 overflow-hidden flex-shrink-0">
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1.5">
                  ...
                  <div className="bg-white/95 rounded-xl p-1 shadow-lg">
                    <Image src="/modern-college/mc-logo.jpg" alt="Modern College" width={28} height={28} className="h-7 w-7 rounded-lg object-contain" />
                  </div>
                </div>
        ...
        {/* Bottom MC campus strip */}
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          transition={{ delay: 0.3 }}
          className="mt-10 rounded-3xl overflow-hidden shadow-xl relative h-36 sm:h-44">
          <Image src="/modern-college/college-gate.webp" alt="PES Modern College Ganeshkhind Campus" fill className="object-cover object-center" />
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4"
            style={{ background: 'rgba(11,31,92,0.72)' }}>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="bg-white rounded-xl p-1">
                <Image src="/modern-college/mc-logo.jpg" alt="Modern College" width={36} height={36} className="h-8 w-auto rounded-lg object-contain" />
              </div>
            </div>
            <p className="text-white font-black text-base sm:text-lg">PES&apos; Modern College, Ganeshkhind, Pune</p>
            <p className="text-[#F5B400] text-xs font-medium mt-0.5">Affiliated to Savitribai Phule Pune University (SPPU) · NAAC Accredited</p>
          </div>
        </motion.div>
