...
import { Phone, MessageCircle, MapPin, Mail, Share2, Users, Video } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:aedp@moderncollege.edu.in" className="flex items-start gap-2.5 text-white/60 hover:text-white transition-colors text-xs">
                  <Mail size={13} className="text-[#F5B400] mt-0.5 flex-shrink-0" />
                  aedp@moderncollege.edu.in
                </a>
              </li>
              <li>
