...
export const metadata: Metadata = {
  title: 'Practical B.COM 2025–26 | Maharashtriya Mandal College Of Commerce, Pune',
  ...
  openGraph: {
    title: 'Practical B.COM 2025–26 | Maharashtriya Mandal College — Earn While You Learn',
